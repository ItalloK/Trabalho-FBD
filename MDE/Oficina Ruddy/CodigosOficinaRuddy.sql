...
CREATE TABLE IF NOT EXISTS `Oficina_Ruddy`.`Clientes` (
  ...
  INDEX `fk_Clientes_Carros1_idx` (`Carros_idCarros` ASC) VISIBLE,
  CONSTRAINT `fk_Clientes_Carros1`
...
CREATE TABLE IF NOT EXISTS `Oficina_Ruddy`.`Servicos` (
  ...
  INDEX `fk_Servicos_Servicos1_idx` (`Servicos_idServicos` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Servicos_Pecas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Servicos_Servicos1`
...
CREATE TABLE IF NOT EXISTS `Oficina_Ruddy`.`Funcionarios` (
  ...
  INDEX `fk_Funcionarios_Servicos1_idx` (`Servicos_idServicos` ASC) VISIBLE,
